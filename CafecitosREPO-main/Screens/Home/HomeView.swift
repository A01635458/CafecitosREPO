        ...
        NavigationStack {
            ScrollView(showsIndicators: false) {
                VStack(spacing: 28) {
                    ...
                    VStack(alignment: .leading, spacing: 14) {
                        Text("Próximas lecciones recomendadas")
                            .font(.system(size: 20, weight: .bold))
                            .padding(.horizontal, 20)
                        
                        NavigationLink(destination: CuppingLessonView()) {
                            ZStack(alignment: .bottomLeading) {
                                AsyncImage(url: URL(string: "https://images.pexels.com/photos/4109744/pexels-photo-4109744.jpeg")) { img in
                                    img.resizable().scaledToFill()
                                } placeholder: {
                                ...
                                VStack(alignment: .leading, spacing: 6) {
                                    Text("Cata Profesional: El Cupping")
                                        .font(.system(size: 20, weight: .bold))
                                        .foregroundStyle(.white)
                                    Text("Aprende el método estándar para evaluar la calidad y el perfil sensorial.")
                                        .font(.system(size: 14))
                                        .foregroundStyle(.white.opacity(0.9))
                                }
                                .padding(20)
